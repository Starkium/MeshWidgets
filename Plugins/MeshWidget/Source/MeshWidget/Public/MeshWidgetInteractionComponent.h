...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnHoveredMeshWidgetChanged, UMeshWidgetComponent*, MeshWidgetComponent, UMeshWidgetComponent*, PreviousMeshWidgetComponent);
...
class MESHWIDGET_API UMeshWidgetInteractionComponent : public USceneComponent
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintAssignable, Category="Interaction|Event")
	FOnHoveredMeshWidgetChanged OnHoveredMeshWidgetChanged;

public:
	UMeshWidgetInteractionComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	...
	UFUNCTION(BlueprintCallable, Category="Interaction")
	UMeshWidgetComponent* GetHoveredMeshWidgetComponent() const;
...
protected:
	...
	UPROPERTY(Transient)
	UMeshWidgetComponent* HoveredMeshWidgetComponent;
